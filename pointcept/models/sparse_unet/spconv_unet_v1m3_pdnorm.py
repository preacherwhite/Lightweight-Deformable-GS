...
@MODELS.register_module("SpUNet-v1m3-Wrap")
class SpUNetBaseV3Wrap(nn.Module):
    def __init__(
        self,
        in_channels,
        num_classes=0,
    ...
    def forward(self, input_dict):
        ...
        feat = point["feat"]
        offset = point["offset"]
        # condition is always ScanNet
        condition = "ScanNet"
        context = point["context"] if "context" in point.keys() else None
